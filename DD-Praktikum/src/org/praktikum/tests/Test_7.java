	...
	public static void main(String[] args) {
		...
		try {
			...
			while (choice == 1) {
				...
				System.out.println("Willst du noch eine Ware einf√ºgen? 1 = ja | 2 = nein");
			...
			if(money < 0) {
				System.out.print("Dein Geld reicht nicht aus dir fehlen noch: " + money + "Ä");
			} else {
				System.out.println(money + "Ä");
			}
		} catch (Exception e){
